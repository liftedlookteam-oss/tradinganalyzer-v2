...
<section className="mt-8 rounded-3xl border border-zinc-800 bg-zinc-950 p-6 md:p-8">
  ...
  <div className="mt-6 grid grid-cols-3 gap-4">
    <div className="rounded-2xl border border-zinc-800 bg-black p-5">
      ...
      <h3 className="mt-4 text-lg font-bold">Upload Charts</h3>
    ...
    <div className="rounded-2xl border border-zinc-800 bg-black p-5">
      ...
      <h3 className="mt-4 text-lg font-bold">Choose Duration</h3>
      <p className="mt-2 text-sm leading-6 text-zinc-400">
        Select how long you plan to hold the trade so the analysis fits your
        timeframe.
      </p>
    </div>
    ...
    <div className="rounded-2xl border border-zinc-800 bg-black p-5">
      ...
      <h3 className="mt-4 text-lg font-bold">Review the Decision</h3>
      <p className="mt-2 text-sm leading-6 text-zinc-400">
        Get structured scenarios, key levels, invalidation and a clear final
        decision.
      </p>
    </div>
  </div>
